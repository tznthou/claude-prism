...
- Claude generates the HTML mockup directly using the same requirements (Tailwind CDN, responsive, semantic HTML5, realistic content).
...
- Note in output: "⚠️ Gemini unavailable ([reason]) — mockup generated by Claude only."
